...
FILAS = [
 ...
 ('Grupo Ambient / Good Events SA', 'Catering desayuno VIP 800 pax — Presupuesto S03362', 'Argentina',
  'Cerrado — esperando seña', 'ARS', 16696800.0, 3506328.0, 20203128.0, 0.50, 10101564.0, 10101564.0, N,
  'Transferencia', 'Good Events SA', '', '', 'Good Events SA', '', '', '', '', '2601021',
  '800 pax × $20.871 + IVA. Ejecutiva: Ángeles García Laborde. Cuenta a nombre de Good Events SA, NO Gourmet Connection SA. Anticipo unificado con S03363.'),
 ...
 ('Grupo Ambient — TOTAL UNIFICADO', 'Anticipo 50% de S03362 + S03363', 'Argentina',
  'Cerrado — esperando seña', 'ARS', 12477450.0, 2620264.5, 15097714.5, 0.50, 15097714.5, 15097714.5, 9835.64,
  'Transferencia', 'Good Events SA', '', '', 'Good Events SA', '', '', '', '', '2601021',
  'ESTA es la invoice emitida. Base neta total $24.954.900. Saldo 50% pendiente de emitir.'),
