...
L = [
 ...
 ("Coffee break estacion abierta all-day (2 dias)","pp",[  120_000,   160_000,   210_000]),
 ("Coctel de bienvenida sin alcohol (lun 20, 2h)","pp",[  110_000,   155_000,   225_000]),
 ("Almuerzo sorpresa colombiano (mar 21)","pp",[  105_000,   140_000,   195_000]),
 ("Almuerzo ejecutivo premium (mie 22)","pp",[   85_000,   110_000,   150_000]),
 ("Cena de cierre en venue exclusivo (mie 22)","pp",[  230_000,   320_000,   480_000]),
 ...
 ("Traslados internos (shuttle cena/fiesta)","fijo",[ 2_500_000,  4_000_000,  6_500_000]),
]
